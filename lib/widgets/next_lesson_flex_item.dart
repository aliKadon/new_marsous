...
import 'package:marsous1/screens/flex_lesson/recording_attendance_view.dart';
...
class NextLessonFlexItem extends StatefulWidget {
  ...
  const NextLessonFlexItem({super.key, required this.index});
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (
                            context) => RecordingAttendanceView(),));
                      },
